export default function Footer() {
    return (
        <>
            ...
            <p className="mb-4">Last updated December 2024, up to cohort #39. Submit a data update to the <a className="underline" href="https://github.com/nqureshi/ev-search-python/tree/main/data">Github repo</a>.</p>
        </>
    )
}